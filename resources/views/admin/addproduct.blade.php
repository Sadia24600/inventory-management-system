                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{route('admin.postaddproduct')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="number" class="form-control" min="1" name="product_quantity" placeholder="Enter product quantity" required>
                        </div>
                        <div class="form-group mt-3">
                            <label for="product_price">Product Price:</label>
                            <input type="number" class="form-control" min="0" name="product_price" placeholder="Enter product price" required>
                        </div>
                        <div class="form-group mt-3">
